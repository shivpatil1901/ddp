...
Example:
    python rudder/eval/evaluate_reinforce_rudder_combined_tests.py \
        ...
        --zero_shot_dataset ddp/rudder/dataset/combined_cost_reward_holdout_200.pkl \
...
def main() -> None:
    ...
    parser.add_argument(
        "--zero_shot_dataset",
        type=str,
        default="ddp/rudder/dataset/combined_cost_reward_holdout_200.pkl",
        help="Dataset from unseen map/layout",
    )
    ...
    if len(zero_shot_trajectories) > 0:
        ...
        results["tests"]["holdout_classifier_accuracy"] = {
            "success": False,
            "skipped": True,
            "reason": "Holdout set unavailable because --zero_shot_dataset was not provided",
        }
