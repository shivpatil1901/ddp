...
dataset_path = 'dataset/safetygym_trpo_goal2/'
...
# Load anti_expert demonstrations (trpo)
anti_expert_path = './dataset/safetygym_trpo_goal2/trpo_{}{}_s0.pickle'.format(robot_name, task_name)
...
# Load expert demonstrations (trpo_lagrangian)
expert_path = './dataset/safetygym_trpo_goal2/trpo_lagrangian_{}{}_s0.pickle'.format(robot_name, task_name)
