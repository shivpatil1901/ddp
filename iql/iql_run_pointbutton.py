...
def main():
    ...
    print("\n" + "="*60)
    print("IQ-Learn for Safety PointButton Environment")
    print("="*60 + "\n")
    ...
    agent, training_metrics = train_iq_learn(
        ...
        save_path="iq_learn_pointbutton_best.pth"
    )
    ...
    np.savez('iq_learn_training_metrics_button.npz',
    ...
    print(f"   ✅ Metrics saved to: iq_learn_training_metrics_button.npz")
    ...
    print("="*70)
    print(f"\nSaved Files:")
    print(f"  - Model checkpoint: iq_learn_pointbutton_best.pth")
    print(f"  - Training metrics: iq_learn_training_metrics_button.npz")
